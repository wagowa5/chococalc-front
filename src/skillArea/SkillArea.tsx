...
const SkillArea = (
    ...
    return (
        ...
        <Grid container spacing={1} margin={1} justifyContent="center" alignItems="start">
            ...
            {/* ----- 3行目 ----- */}
            <Grid item xs={6}>
                <Button variant="outlined" onClick={handleFairyKingBlessingPhy}>妖精王の祝福(物理)</Button>
            </Grid>
            <Grid item xs={6}>
                <Button variant="outlined" onClick={handleFairyKingBlessingMag}>妖精王の祝福(魔法)</Button>
            </Grid>
            
            {/* ----- 4行目 ----- */}
            <Grid item xs={6}>
                <Button variant="outlined" onClick={handleArchangelBlessing}>大天使の加護</Button>
            </Grid>
            <Grid item xs={6}>
                <Button variant="outlined" onClick={handleBlessedAzureAegis}>祝福の蒼盾</Button>
            </Grid>

            {/* ----- 5行目 ----- */}
            <Grid item xs={6}>
                <Button variant="outlined" onClick={handleWisdomKingInspirationYang}>明王の鼓舞・陽</Button>
            </Grid>
            <Grid item xs={6}>
                <Button variant="outlined" onClick={handleWisdomKingProtectionYin}>明王の守護・陰</Button>
            </Grid>
            
            {/* ----- 6行目 ----- */}
            <Grid item xs={6}>
                <Button variant="outlined" onClick={handleEvilGodCurse}>邪神の呪詛</Button>
            </Grid>
            <Grid item xs={6}></Grid>
        </Grid>
        </>
